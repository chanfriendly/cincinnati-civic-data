...
const SECTIONS: RoadmapSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'City Budget & Spending Tracker',
        status: 'planned',
        description: 'Show how much the city is spending per neighborhood on core services — code enforcement, parks maintenance, street repair, community centers — and whether spending patterns correlate with neighborhood conditions as measured by this platform.',
        why: 'The City of Cincinnati publishes an annual budget and a Capital Improvements Program, but neither is easily searchable by neighborhood. Understanding whether a neighborhood\'s deteriorating conditions reflect reduced city investment — or whether investment is happening and not working — is a fundamentally different policy question.',
