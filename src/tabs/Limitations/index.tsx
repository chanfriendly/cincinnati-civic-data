      ...
      >
        <div className="bg-gray-900 text-white rounded-xl p-5">
          <p className="text-sm leading-relaxed mb-4">
            Found a number that looks wrong? A caveat we missed? A dataset we should add? Please file an issue.
            For data disputes, include the address or neighborhood, the exact number on the site, and the source
            you&rsquo;re comparing against &mdash; it makes diagnosis much faster.
          </p>
          <div className="flex flex-wrap gap-3 text-sm">
            ...
            <a
              ...
              target="_blank" rel="noopener noreferrer"
              className="bg-white/10 text-white border border-white/20 px-4 py-2 rounded-lg font-medium hover:bg-white/20 transition-colors"
            >
