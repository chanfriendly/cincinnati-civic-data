...
const VINTAGE_ROWS: VintageRow[] = [
  ...
  { source: 'CDC USALEEP Life Expectancy',        usedIn: 'Neighborhood Profiles (Life Expectancy)',           vintage: '2010–2015',         refresh: 'Rebuilt on new release (none since)', notes: 'Only USALEEP release to date. Single-tract estimates flagged as lower confidence' },
]
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <nav aria-label="Sections on this page" className="mb-10 rounded-md p-4" style={{ background: C.limestone, border: `1px solid ${C.rule}` }}>
        ...
        <div className="flex flex-wrap gap-2 text-xs">
          {[
            ...
            ['students',   'For students & researchers'],
            ['i18n',       'Language'],
      ...
      <Section
        ...
        Icon={BotIcon}
        iconStyle={{ background: C.riverLight, color: C.riverDeep }}
        heading="AI on this site"
        subheading="The site's AI features were removed in July 2026. Nothing you read here is generated by a language model."
      >
        <Caveat
          title="AI-generated summaries and Q&A were removed in July 2026."
          severity="info"
          body={
            <>
              <p className="mb-2">
                Earlier versions of this site included an AI-generated &ldquo;Plain English Summary&rdquo; in Address
                Lookup, an AI Q&amp;A in the Police tab, and AI-written neighborhood blurbs in the Explorer, powered by
                a language model via OpenRouter. They were removed because the project has no ongoing funding for AI
                API costs and no maintainer to audit output quality &mdash; and an unaudited AI summary is worse than
                no summary.
              </p>
              <p>
                The feature code and prompts are preserved in the project&rsquo;s git history as a starting point for a
                future maintainer who can commit to funding and reviewing it. Every chart and number on the site works
                without it.
              </p>
            </>
          }
        ...
        <Caveat
          title="No AI is used for any scoring, ranking, or classification."
          severity="info"
          body={
            <p>
              ...
              The one machine-generated element that remains is the Spanish translation &mdash; see the Language section below.
            </p>
          }
        />
      </Section>
      ...
      {/* ─── Section 7: For students & researchers ──────────────────────────── */}
      <Section
        id="students"
        Icon={DatabaseIcon}
        iconStyle={{ background: C.riverLight, color: C.riverDeep }}
        heading="For students &amp; researchers"
        subheading="Guidance for community health assessments, coursework, and anything you plan to cite."
      >
        <Caveat
          title="Some parts of a community assessment cannot come from this site — by design."
          severity="gap"
          body={
            <>
              <p className="mb-2">
                Community health assessment frameworks (including the one used in nursing curricula) ask about a
                neighborhood&rsquo;s <strong>history</strong>, its residents&rsquo; <strong>values and beliefs</strong>, and
                <strong> residents&rsquo; own perceptions</strong> of their community. No public dataset captures these at
                the neighborhood level &mdash; Cincinnati&rsquo;s Community Perceptions Survey is city-wide only, and we
                deliberately do not fabricate proxies for qualitative dimensions.
              </p>
              <p>
                These must come from fieldwork: windshield surveys, key informant interviews, community council
                meetings, and conversations with residents. Use this site to prepare for fieldwork and to check
                quantitative claims &mdash; not to replace it. The Community &amp; Civic section of each Neighborhood
                Profile lists the community council contacts where that fieldwork can start.
              </p>
            </>
          }
        />
        ...
        <Caveat
          title="Health outcome figures are model-based estimates, not clinical measurements."
          severity="warn"
          body={
            <p>
              CDC PLACES values are small-area statistical estimates derived from the BRFSS survey &mdash; appropriate
              for screening and comparison, not for clinical or diagnostic claims about a neighborhood&rsquo;s residents.
              Life expectancy (CDC USALEEP) reflects 2010&ndash;2015 &mdash; the only release of that project to date &mdash;
              and single-tract neighborhoods are flagged as lower confidence. Composite indices on this site (Explorer
              scores, Senior Vulnerability Score, displacement phases) are <em>relative rankings within Cincinnati</em>,
              normalized against the city-wide range with equal weights &mdash; they are not validated clinical or policy
              instruments and should never be cited as such.
            </p>
          }
        />

        <Caveat
          title="How to cite: prefer the primary source; cite this site as the aggregator."
          severity="info"
          body={
            <>
              <p className="mb-2">
                Every section on this site names its source and vintage. For formal work, cite that primary source
                (e.g. &ldquo;U.S. Census Bureau, ACS 5-Year Estimates, Table B19080&rdquo; or &ldquo;CDC PLACES, 2023
                release&rdquo;), and cite this platform for the aggregation, neighborhood mapping, and any derived
                scores you reference:
              </p>
              <p className="rounded-md p-3 text-xs" style={{ background: C.limestone, border: `1px solid ${C.rule}` }}>
                Cincinnati Civic Data Platform. <em>[Tab or section name]</em>. https://cincinnati-civic-data.vercel.app
                (accessed [date]). Underlying data: [primary source and vintage as shown in the section].
              </p>
              <p className="mt-2">
                Because tract-to-neighborhood mapping uses nearest centroid (see the boundaries section above), figures
                here may differ slightly from analyses that use exact spatial joins or Community Council boundaries.
                Note the mapping method when precision matters.
              </p>
            </>
          }
        />
      ...
      <p className="text-xs mt-4 mb-8" style={{ color: C.muted }}>
        This page is hand-maintained. Last reviewed: July 2026.
      </p>
    </div>
  )
}
